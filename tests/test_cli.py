...
@pytest.mark.parametrize("command,action,args", [
    ...
    ("asset", "delete", ["asset", "org/user", "erase", "1.0.0", "*foo*"]),
    ("asset", "delete", ["asset", "org/user", "erase", "1.0.0", "*foo*", "--keep-pattern", "*bar*"]),
    # # ref
    ...
    ("release", "create", ["release", "org/user", "create", "1.0.0", "--target-commitish", "1234567"]),
    ("release", "edit", ["release", "org/user", "edit", "1.0.0", "--tag-name", "new_tag"]),
    ("release", "edit", ["release", "org/user", "edit", "1.0.0", "--target-commitish", "1234567"]),
